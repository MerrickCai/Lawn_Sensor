# -*- coding: utf-8 -*-
"""BlueViolets With Colors.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1HTOznlyxYQ-LvJ1MncuCRSio9wy7Herp
"""
...
project = rf.workspace("plantstesting").project("blue-violets")
version = project.version(1)
dataset = version.download("yolov11")

model = YOLO('yolo11n.pt')
results = model.train(data="/content/Blue-Violets-1/data.yaml", epochs=1, imgsz=64,save=True,save_period=5,time=10)

results = model(source="/content/Blue-Violets-1/train/images",conf=0.005)
...
image_path = '/content/Blue-Violets-1/train/images/medium-262_jpeg.rf.1dc69eb04a0c6571087e526f293b2868.jpg'  # Replace with your image path
detect_colors(image_path, overlap=True)  # With overlapping

import os
image_path = '/content/Blue-Violets-1/train/images'  # Path to your image directory
