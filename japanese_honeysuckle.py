# -*- coding: utf-8 -*-
"""Japanese Honeysuckle.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/159m-VGeeXNIA7LuHfnn9jIylDJPswE2z
"""
...
project = rf.workspace("toxic-plants").project("japanese-honeysuckle")
version = project.version(1)
dataset = version.download("yolov11")

model = YOLO('yolo11n.pt')
results = model.train(data="/content/Japanese-Honeysuckle-1/data.yaml", epochs=1, imgsz=64,save=True,save_period=5,time=10)

results = model(source="/content/Japanese-Honeysuckle-1/train/images",conf=0.005)
...
colors = {
    ...
    'brown': ([10, 100, 20], [17, 255, 200]),  # Dead leaves/grass (Adjusted)
    'green': ([20, 80, 20], [75, 255, 255]),  # Grass/greenery (Adjusted)
    'purple': ([140, 80, 50], [155, 255, 255]),  # Purple flowers
    'yellow': ([20, 100, 100], [40, 255, 255]),  # Yellow flowers
    'white': ([0, 0, 200], [180, 30, 255])  # Snow
}
...
import os
image_path = '/content/Japanese-Honeysuckle-1/train/images'  # Path to your image directory
